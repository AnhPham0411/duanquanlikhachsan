  ...
  @include('layouts.user-header')
    ...
    <div class="slide-one-item home-slider owl-carousel">
      ...
      <div class="site-blocks-cover overlay" style="background-image: url({{ asset('hotel/images/hero_2.jpg')}});" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
      ...
      <div class="site-blocks-cover overlay" style="background-image: url({{ asset('hotel/images/hero_3.jpg')}});" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              <a href="#" class="d-block mb-0 thumbnail"><img src="{{ asset('hotel/images/img_1.jpg')}}" alt="Image" class="img-fluid"></a>
          ...
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              <a href="#" class="d-block mb-0 thumbnail"><img src="{{ asset('hotel/images/img_2.jpg')}}" alt="Image" class="img-fluid"></a>
              <div class="hotel-room-body">
          ...
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              <a href="#" class="d-block mb-0 thumbnail"><img src="{{ asset('hotel/images/img_3.jpg')}}" alt="Image" class="img-fluid"></a>
              <div class="hotel-room-body">
          ...
          <div class="col-md-6 mb-5 mb-md-0">
              ...
              <div class="img-border">
                <a href="https://vimeo.com/28959265" class="popup-vimeo image-play">
                  ...
                  <img src="{{ asset('hotel/images/img_2.jpg')}}" alt="" class="img-fluid">
                </a>
              </div>

              <img src="{{ asset('hotel/images/img_1.jpg')}}" alt="Image" class="img-fluid image-absolute">
    ...
    <div class="py-5 upcoming-events" style="background-image: url('{{ asset('hotel/images/hero_1.jpg')}}'); background-attachment: fixed;">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6">
      ...
      <div class="container">
        ...
        <div class="row no-gutters">
          <div class="col-md-6 col-lg-3">
            <a href="images/img_1.jpg" class="image-popup img-opacity"><img src="{{ asset('hotel/images/img_1.jpg')}}" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-md-6 col-lg-3">
            <a href="images/img_2.jpg" class="image-popup img-opacity"><img src="{{ asset('hotel/images/img_2.jpg')}}" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-md-6 col-lg-3">
            <a href="images/img_3.jpg" class="image-popup img-opacity"><img src="{{ asset('hotel/images/img_3.jpg')}}" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-md-6 col-lg-3">
            <a href="images/img_4.jpg" class="image-popup img-opacity"><img src="{{ asset('hotel/images/img_4.jpg')}}" alt="Image" class="img-fluid"></a>
          </div>
          ...
          <div class="col-md-6 col-lg-3">
            <a href="images/img_5.jpg" class="image-popup img-opacity"><img src="{{ asset('hotel/images/img_5.jpg')}}" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-md-6 col-lg-3">
            <a href="images/img_6.jpg" class="image-popup img-opacity"><img src="{{ asset('hotel/images/img_6.jpg')}}" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-md-6 col-lg-3">
            <a href="images/img_7.jpg" class="image-popup img-opacity"><img src="{{ asset('hotel/images/img_7.jpg')}}" alt="Image" class="img-fluid"></a>
          </div>
      ...
      <div class="container">
        ...
        <div class="nonloop-block-15 owl-carousel">
            ...
            <div class="media-with-text p-md-5">
              <div class="img-border-sm mb-4">
                <a href="#" class="popup-vimeo image-play">
                  <img src="{{ asset('hotel/images/img_1.jpg')}}" alt="" class="img-fluid">
                </a>
              </div>
            ...
            <div class="media-with-text p-md-4">
              <div class="img-border-sm mb-4">
                <a href="#" class="popup-vimeo image-play">
                  <img src="{{ asset('hotel/images/img_3.jpg')}}" alt="" class="img-fluid">
                </a>
              </div>
              <h2 class="heading mb-0"><a href="#">Lorem Ipsum Dolor Sit Amet</a></h2>
              <span class="mb-3 d-block post-date">Dec 20th, 2018 &bullet; By <a href="#">Admin</a></span>
