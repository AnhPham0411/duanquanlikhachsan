...
<head>
  ...
  <title>Chỉnh sửa khách hàng - NiceAdmin Bootstrap Template</title>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Form chỉnh sửa khách hàng</h5>
              ...
              <form action="{{ route('customers.update', $customer->id) }}" method="POST">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="number" name="point" class="form-control" value="{{ old('point', $customer->point) }}" min="0">
                  </div>
                </div>
