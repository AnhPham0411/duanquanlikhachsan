...
<head>
  ...
  <title>Thêm tiện nghi - NiceAdmin Bootstrap Template</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Thêm tiện nghi</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Form thêm tiện nghi</h5>

              <!-- General Form Elements -->
              <form action="{{ route('amenities.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row mb-3">
                  <label for="name" class="col-sm-2 col-form-label">Tên tiện nghi</label>
                  <div class="col-sm-10">
                ...
                <div class="row mb-3">
                  <label for="image" class="col-sm-2 col-form-label">Ảnh tiện nghi</label>
                  <div class="col-sm-10">
                    <input type="file" name="image" class="form-control" accept="image/*" required>
                    <small class="text-muted">Vui lòng chọn một ảnh (bắt buộc).</small>
                  </div>
                </div>
                <div class="row mb-3">
