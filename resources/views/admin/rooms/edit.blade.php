...
<head>
  ...
  <title>Edit Room - NiceAdmin Bootstrap Template</title>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="{{ route('rooms.update', $room->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <label for="room_number" class="col-sm-2 col-form-label">Số phòng</label>
                    <div class="col-sm-10">
                ...
                <div class="row mb-3">
                    <label for="capacity" class="col-sm-2 col-form-label">Số lượng người</label>
                    <div class="col-sm-10">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select name="type" class="form-select" required>
                      ...
                      <option value="single" {{ $room->type == 'single' ? 'selected' : '' }}>Phòng đơn</option>
                      <option value="double" {{ $room->type == 'double' ? 'selected' : '' }}>Phòng đôi</option>
                      <option value="suite" {{ $room->type == 'suite' ? 'selected' : '' }}>Phòng suite</option>
                    </select>
                  </div>
                </div>
